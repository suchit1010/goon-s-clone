...
const members = [
  ...
  },
  {
    ...
    role: 'CEO @ Credit Markets & VitalFi',
  ...
  },
  {
    ...
    handle: '@r0dtr',
    role: 'CSO @ Credit Markets',
    company: 'Credit Markets',
    skills: ['Fintech', 'Strategy', 'Biz Dev'],
    isCore: false,
...
const skillFilters = ['All', 'Core Team', 'Dev', 'Rust', 'Content', 'Growth', 'Biz Dev'];
